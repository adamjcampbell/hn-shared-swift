...
Superseded by [ADR-0026](0026-replace-registry-with-tasks-slots.md) (2026-06-15): the `TaskRegistry` it observed is gone, so tests await `Model` transitions via `waitUntil` instead. The `settle`-retirement it introduced stands.
